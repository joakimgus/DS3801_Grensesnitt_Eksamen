...
const POS_Footer = (props) =>{
    ...
    return(
        <nav>
            ...
            <div className="POS_Footer" id="drinks"><img src={posFooterIcons[1].image} alt={posFooterIcons[1].alt}></img>
            <p>Drinks</p>
            </div>
            <div className="POS_Footer" id="food"><img src={posFooterIcons[3].image} alt={posFooterIcons[3].alt}></img>
            <p>Food</p>
            </div>
            <div className="POS_Footer" id="orders"><img className="POS_Button" src={posFooterIcons[2].image} alt={posFooterIcons[2].alt}></img></div>
            <div className="POS_Footer" id="receipts"><img className="POS_Button" src={posFooterIcons[5].image} alt={posFooterIcons[5].alt}></img></div>
